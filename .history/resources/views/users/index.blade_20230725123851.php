                ...
                { data: 'country', name: 'country' },
                {
                    ...
                    render: function (data) {
                        var showBtn = '<a href="{{ route("user.show", [":id"]) }}" class="btn btn-info btn-sm">Show</a>'
                            .replace(':id', data.id);
                        var editBtn = '<button href="{{ route("user.show", [":id"]) }}" class="btn btn-primary btn-sm edit-btn" data-id="' + data.id + '">Edit</button>';
                        var deleteBtn = '<button class="btn btn-danger btn-sm delete-btn" data-id="' + data.id + '">Delete</button>';
