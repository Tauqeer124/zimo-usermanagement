    ...
    render: function (data, type, row) {
        ...
        var toggleSwitch = `
            <input data-id="${row.id}" class="toggle-class" type="checkbox" 
                ...
                <input data-id="${row.id}" class="toggle-class" type="checkbox" data-onstyle="success" data-offstyle="danger" data-toggle="toggle" data-on="Active" data-off="InActive" ${checked}>
        `;
