...
<script type="text/javascript">
    ...
    $('#applyFiltersBtn').on('click', function () {
        ...
        var filterCountry = $('#filter_country').val();
         // Format filter date to match database format (YYYY-MM-DD)
         if (filterDate !== '') {
            var formattedFilterDate = moment(filterDate).format('YYYY-MM-DD');
            $('#filter_date').val(formattedFilterDate); // Update the filter date input with the formatted value
        }
