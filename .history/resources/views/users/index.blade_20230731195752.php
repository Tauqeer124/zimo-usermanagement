        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form id="addUserForm">
                    ...
                    <div class="form-group">
                        <label for="city">Ge</label>
                        <input type="text" class="form-control" id="c.name" name="city" required>
                    </div>
    ...
    $(function () {
        ...
        var table = $('.data-table').DataTable({
            ...
            columns: [
                ...
                { data: 'userDetail.gender', name: 'userDetail.gender' },
        ...
        if (filterCountry !== '') {
            table.column('country.name:name').search(filterCountry).draw();
        }
    });
