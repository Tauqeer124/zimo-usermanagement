                ...
                { data: 'country', name: 'country' },
                {
                    ...
                    render: function (data) {
                        var showBtn = '<a href="{{ route("user.show", [":id"]) }}" class="btn btn-info btn-sm">Show</a>'
                            .replace(':id', data.id);
                        var editBtn = '<a href="{{ route("users.edit", [":id"]) }}" class="btn btn-primary btn-sm edit-btn" >Edit</a>'.replace(':id', data.id);
                        var deleteBtn = '<a href="{{ route("user.delete", [":id"]) }}" class="btn btn-danger btn-sm delete-btn" data-id="' + data.id + '">Delete</button>';
