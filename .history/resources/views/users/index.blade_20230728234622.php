...
<script>
    $(document).ready(function() {
        ...
        function applyFilters() {
            ...
            const filterCountry = $('#filter_country').val();

            if (dataTable) {
                dataTable.columns(3).search(filterDate).draw();
                dataTable.columns(4).search(filterCountry).draw();
            }
        }
        ...
        $('#filter_date, #filter_country').on('keyup', function() {
            applyFilters();
        });

        // Apply filters on datepicker date change
