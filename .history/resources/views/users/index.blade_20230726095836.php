            ...
            <form id="filter-form">
                ...
                <select name="country" id="country">
                    ...
                    @foreach($country as $countr)
                        <option value="{{ $countr }}">{{ $countr}}</option>
                    @endforeach
                </select>
...
<script type="text/javascript">
    $(function () {
        ...
        $('.data-table').on('click', '.delete-btn', function () {
            ...
            // Function to handle the form submission for filters
            $('#filter-form').on('submit', function (e) {
                e.preventDefault();
                var formData = $(this).serialize();
                table.ajax.url('{{ route('users.data') }}?' + formData).load();
            });

            // Function to handle the click event of toggle buttons
