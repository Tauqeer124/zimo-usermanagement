                ...
                <form id="editUserForm">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" id="editCountry" name="country_id" required>
                            <option value="">Select Country</option>
                            @foreach($countries as $country)
                                <option value="{{ $country->id }}" {{ $item->item == $bt->item_name ? 'selected' : '' }}>{{ $country->name }}</option>
                            @endforeach
                        </select>
                    </div>
                    @foreach ($ratelist as $item)
                    <option value="{{ $item->item }}" {{ $item->item == $bt->item_name ? 'selected' : '' }}
                        data-price="{{ $item->price }}">{{ $item->item }}</option>
                @endforeach
                    <div class="form-group">
