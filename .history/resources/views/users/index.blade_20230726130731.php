        ...
        var table = $('.data-table').DataTable({
            ...
            columns: [
                ...
                render: function (data, type, row) {
                        ...
                        <input data-id= class="toggle-class" type="checkbox" data-onstyle="success" data-offstyle="danger" data-toggle="toggle" data-on="Active" data-off="InActive" {{ $user->status ? 'checked' : '' }}>
