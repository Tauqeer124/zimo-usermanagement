            ...
            <table class="table table-bordered data-table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <button><a href="{{ route("userdetail.edit", $userdetail->id) }}" class="btn btn-primary" data-id="$userdetail->id" data-toggle="modal" data-target="#editUserDetailModal">Edit</a><bu>
