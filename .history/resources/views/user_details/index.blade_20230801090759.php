            ...
            <table class="table table-bordered data-table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <button  href="{{ route("userdetail.edit", $userdetail->id) }}" class="btn btn-primary" data-id="$userdetail->id" data-toggle="modal" data-target="#editUserDetailModal">Edit</button>
                            
                       
                            
                               
                                <button  href="{{ route("userdetail.delete" ,$userdetail->id)}}"  data-id="$userdetail->id" class="btn btn-danger btn-sm">Delete</button>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" id="user" name="user_id" required>
                            ...
                            @foreach($users as $user)
                                <option value="{{ $user->id }}" >{{ $user->country }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="form-group">
