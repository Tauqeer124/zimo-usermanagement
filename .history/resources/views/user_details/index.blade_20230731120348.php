            ...
            <table class="table table-bordered data-table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <button type="button"><a href="{{ route("userdetail.edit", $userdetail->id) }}" class="btn btn-primary" data-id="$userdetail->id" data-toggle="modal" data-target="#editUserDetailModal">Edit</a> </button>
                            
                       
                            <form action="{{ route('userdetail.delete', $userdetail->id) }}" method="POST">
                               
                                <button type="submit"href="{{ route("userdetail.delete")}}"  data-id="$userdetail->id" class="btn btn-danger btn-sm">Delete</button>
                            </form>
                        </td>
                    </tr>
                    @endforeach
