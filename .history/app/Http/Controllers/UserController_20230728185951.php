    ...
    public function index(Request $request)
{
    ...
    $searchcountries = Country::pluck('name')->all();
    ...
    if ($request->ajax()) {
        ...
        if ($request->has('filter_country')) {
            ...
            $data->where('countries.name as country_name', 'LIKE', '%' . $filterCountry . '%');
        }
    ...
    return view('users.index', compact('countries','searchcountries'));
}
