...
class UserController extends Controller
{
    ...
    {
        // Get the country_id from the request
        ...
        // Query the users table with relationships
        $users = User::with('country', 'userDetail');
        ...
        // Apply ordering (ascending or descending) if provided
        $orderBy = $request->input('order_by', 'asc');
        $users->orderBy('created_at', $orderBy);
        $result = $users->paginate($perPa);

        // Return the paginated user resources with relationships
