...
class UserController extends Controller
{
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            $data = User::select(['id', 'name', 'email', 'phone', 'country',  'created_at']);
        ...
        $users->where('country', $country);
            ...
            return Datatables::of($data)
                    ...
                    ->addColumn('action', function ($row) {
                        ...
                        return '<button class="btn-toggle-status" data-user-id="' . $row->id . '" data-status="' . $status . '">' . ucfirst($status) . '</button>';
    ...
    $users = User::select(['id', 'name', 'email', 'phone', 'country',  'created_at']);
