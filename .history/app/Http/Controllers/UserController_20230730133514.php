 ...
 public function index(Request $request)
    {
        ...
        $countries = Country::get();
        $filterCountry = $request->input('filter_country');
        $country = User::where('country_id', '=',  $filterCountry)->get;
        dd($country);
       
            $filterCountry = $request->input('filter_country');
            $country = User::where('country', 'LIKE', '%' . $filterCountry . '%');
        
        
        
        // dd($countries);
        // $data = User::select('users.*', 'countries.name as name')
        ...
        if ($request->ajax()) {
            ...
            if ($request->has('filter_country')) {
                ...
                $query->where('country', 'LIKE', '%' . $filterCountry . '%');
            }
