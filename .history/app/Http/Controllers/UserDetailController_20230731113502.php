...
{
    protec function uploadImage(Request $request)
    {
        $request->validate([
    ...
    public function index()
    {
        ...
        return view('user_details.index', compact('userdetails','users'));
    }
    ...
    public function destroy($id)
    {
        ...
        // Delete the UserDetail record from the database
        $userDetail->delete();

        return redirect()->route('userdetails.index')->with('success', 'User detail deleted successfully.');
    }
