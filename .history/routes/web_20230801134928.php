...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/uploadimage',[UserController::class, 'uploadimage']);
    Route::post('/uploadimage',[UserController::class, 'storeimage']);
    //graph routes
    //graph routes
    ...
    Route::post('/userdetail/add', [UserDetailController::class, 'store'])->name('adduserdetail');
    Route::get('/userdetail/edit/{id}', [UserDetailController::class, 'edit'])->name('userdetail.edit');
    Route::put('/userdetail/update/{id}', [UserDetailController::class, 'update'])->name('userdetail.update');
    Route::get('/userdetail/delete/{id}', [UserDetailController::class, 'destroy'])->name('userdetail.delete');
